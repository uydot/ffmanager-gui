      ...
      <div className="col-12 lg:col-6">
        ...
        <div className="card">
          ...
          <AvatarGroup className="mb-3">
            <Avatar
              image="assets/ui/images/avatar/amyelsner.png"
              size="large"
              shape="circle"
            ></Avatar>
            <Avatar
              image="assets/ui/images/avatar/asiyajavayant.png"
              size="large"
              shape="circle"
            ></Avatar>
            <Avatar
              image="assets/ui/images/avatar/onyamalimba.png"
              size="large"
              shape="circle"
            ></Avatar>
            <Avatar
              image="assets/ui/images/avatar/ionibowcher.png"
              size="large"
              shape="circle"
            ></Avatar>
            <Avatar
              image="assets/ui/images/avatar/xuxuefeng.png"
              size="large"
              shape="circle"
            ></Avatar>
            <Avatar
